...
// BlockCypher's free tier caps out around 100 requests/hour regardless of token, and
// ~2,000/day. At 30s polling, even ONE pending LTC trade blows past that (120 req/hr).
// 90s keeps it comfortably under, with room for a couple more trades running concurrently.
// When ready to scale (100+ trades/day), switch to NOWNodes (see README) and this can
// drop back down to 30s.
